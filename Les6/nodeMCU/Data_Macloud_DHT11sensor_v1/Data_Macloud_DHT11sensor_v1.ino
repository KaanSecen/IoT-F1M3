...
String deviceID = "24114"; // let op geen spaties
/* 
...
*/
const char* ssid     = "ziggo-ap-7801945"; // wifi lan
const char* password = "^aMPAaX%PZ.6%"; // wifi lan
/*
 * Ma-cloud 
*/
String server  = "http://kaansecen.nl";          // deployment server
String pathSendData = "/School/IOT/duurzaam1/jsonWrite.php?src=esp&data="; // path to file
